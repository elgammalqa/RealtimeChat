...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[DownloadManager image:dbmessage.picture md5:dbmessage.pictureMD5 completion:^(NSString *path, NSError *error, BOOL network)
	{
		if (error == nil)
		{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	rcmessage.status = STATUS_LOADING;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[DownloadManager video:dbmessage.video md5:dbmessage.videoMD5 completion:^(NSString *path, NSError *error, BOOL network)
	{
		if (error == nil)
		{
			if (network) [Cryptor decryptFile:path chatId:dbmessage.chatId];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	rcmessage.status = STATUS_LOADING;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[DownloadManager audio:dbmessage.audio md5:dbmessage.audioMD5 completion:^(NSString *path, NSError *error, BOOL network)
	{
		if (error == nil)
		{
			if (network) [Cryptor decryptFile:path chatId:dbmessage.chatId];
