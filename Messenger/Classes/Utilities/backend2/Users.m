...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	NSString *child = [NSString stringWithFormat:@"%@/%@", FUSER_LINKEDIDS, [FUser currentId]];
	FIRDatabaseQuery *query = [[firebase queryOrderedByChild:child] queryEqualToValue:@YES];
	//---------------------------------------------------------------------------------------------------------------------------------------------
