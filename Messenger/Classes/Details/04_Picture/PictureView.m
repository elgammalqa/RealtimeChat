...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	NYTPhotoItem *photoItem = self.currentlyDisplayedPhoto;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	UIImageWriteToSavedPhotosAlbum(photoItem.image, self, @selector(video:didFinishSavingWithError:contextInfo:), nil);
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	NYTPhotoItem *photoItem = self.currentlyDisplayedPhoto;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	NSPredicate *predicate = [NSPredicate predicateWithFormat:@"objectId == %@", photoItem.objectId];
	DBMessage *dbmessage = [[DBMessage objectsWithPredicate:predicate] firstObject];
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	NYTPhotoItem *photoItem = self.currentlyDisplayedPhoto;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	UIActivityViewController *activity = [[UIActivityViewController alloc] initWithActivityItems:@[photoItem.image] applicationActivities:nil];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	[File remove:path];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[ProgressHUD showSuccess:@"Deleted from local cache."];
}
